...
![The structure of SG Regression Module](illumination-estimation-note\images\(2022 AAAI) Rendering-Aware HDR Environment Map Prediction from a Single Image1.png)

![The structure of SH Regression Module](illumination-estimation-note\images\2022 AAAI) Rendering-Aware HDR Environment Map Prediction from a Single Image2.png)

![The structure of the generative network](illumination-estimation-note\images\(2022 AAAI) Rendering-Aware HDR Environment Map Prediction from a Single Image3.png)
...
![Overview of system](illumination-estimation-note\images\(2020 ECCV) Object-based Illumination Estimation with Rendering-aware Neural Networks1.png)
